# ClaudeKit Marketing - Code Standards & Development Guidelines
...
ClaudeKit Marketing follows a **distributed agent orchestration architecture** with the following core principles:
